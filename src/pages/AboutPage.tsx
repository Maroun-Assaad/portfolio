...
const technicalSkills = [
  ...
  { name: "Git", level: 80, color: "bg-gray-500" },
  { name: "firebase", level: 80, color: "bg-yellow-500" },
  { name: "SQL", level: 75, color: "bg-purple-500" },
  { name: "Java", level: 70, color: "bg-red-500" },
  { name: "PHP", level: 70, color: "bg-purple-700" },
  { name: "Flutter", level: 60, color: "bg-orange-500" },
  { name: "React Native", level: 55, color: "bg-blue-500" },
  // { name: "C#", level: 70, color: "bg-purple-700" },
  // { name: "Kotlin", level: 60, color: "bg-purple-500" },
  // { name: "Swift", level: 60, color: "bg-pink-500" },
  // { name: "Tailwind CSS", level: 85, color: "bg-teal-500" },
  // { name: "Figma", level: 70, color: "bg-pink-500" },
  // { name: "NoSQL", level: 70, color: "bg-red-500" },
